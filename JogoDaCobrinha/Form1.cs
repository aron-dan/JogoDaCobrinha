    ...
    public partial class Form1 : Form
    {
        ...
        */
        ...
        private void TakeSnapShot(object sender, EventArgs e)
        {
            ...
            caption.Text = "I Scored " + score + " adn my HighScore is" + hightScore;
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                picCanvas.DrawToBitmap(bpm, new Rectangle(0,0, width, height));
                bpm.Save(dialog.FileName, ImageFormat.Jpeg);
        ...
        private void UpdatePictureBoxGraphics(object sender, PaintEventArgs e)
        {
            ...
            for (int i = 0; i < Snake.Count; i++)
            {
                ...
                canvas.FillEllipse(snakeColour, new Rectangle
                    (
                    Snake[i].X * Settings.Widh,
                    Snake[i].Y * Settings.Height,
                    Settings.Widh, Settings.Height
        ...
        private void RestarGame()
        {
            ...
            maxWidth = picCanvas.Width / Settings.Widh - 1;
            maxHeight = picCanvas.Height / Settings.Height - 1;

            Snake.Clear();

            startButtom.Enabled = false;
            snapButtom.Enabled = false;

            score = 0;
            txtScore.Text = "Score: " + score;
            Circle head = new Circle { X = 10, Y = 5 };
            Snake.Add(head); //adding the head part of the snale to the list
        ...
        private void GameOver()
        {
            ...
            snapButtom.Enabled = true;

            if (score > hightScore)
            {
                hightScore = score;

                txtHighScore.Text = "HighScore: " + Environment.NewLine + hightScore;
